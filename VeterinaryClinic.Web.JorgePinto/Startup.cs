...
namespace VeterinaryClinic.Web.JorgePinto
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<User, IdentityRole>(cfg =>
            {
                ...
                cfg.SignIn.RequireConfirmedEmail = true; //******* TRUE PARA CONFIRMAÇÃO E-MAIL******
                ...
                cfg.Password.RequiredLength = 6; //Mesma qtde. na RegisterNewUserViewModel
